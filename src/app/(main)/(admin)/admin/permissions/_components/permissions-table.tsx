...
import { PERMISSIONS_EVENTS, PermissionsRefreshDetail } from "./events"
...
export default function PermissionsTable({
  ...
  useEffect(() => {
    const handleRefresh = (event: Event) => {
      const customEvent = event as CustomEvent<PermissionsRefreshDetail>
    ...
    window.addEventListener(PERMISSIONS_EVENTS.REFRESH, handleRefresh)
    return () => window.removeEventListener(PERMISSIONS_EVENTS.REFRESH, handleRefresh)
  }, [])
